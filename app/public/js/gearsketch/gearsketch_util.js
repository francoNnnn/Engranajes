...
(function() {
  ...
  ArcSegment = (function() {
    function ArcSegment(center, radius, startAngle, endAngle, direction1) {
      this.center = center;
      this.radius = radius;
      this.startAngle = startAngle;
      this.endAngle = endAngle;
      this.direction = direction1;
      this.start = this.pointOnCircle(this.startAngle);
      this.end = this.pointOnCircle(this.endAngle);
    }
  ...
  Util = (function() {
    ...
    Util.clone = function(obj) {
      var copy, i, k, key, knownClasses, ref, ref1;
      if ((obj == null) || (typeof obj !== "object")) {
        return obj;
      }
      knownClasses = ["Point", "Gear", "ArcSegment", "LineSegment", "Chain"];
      if (ref = obj.constructor.name, indexOf.call(knownClasses, ref) >= 0) {
        return obj.clone();
      }
      if (obj instanceof Array) {
        copy = [];
        for (i = k = 0, ref1 = obj.length; 0 <= ref1 ? k < ref1 : k > ref1; i = 0 <= ref1 ? ++k : --k) {
    ...
    Util.getLength = function(path, isPathClosed) {
      var finalIndex, i, j, k, length, numberOfPoints, ref;
      ...
      for (i = k = 0, ref = finalIndex; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
        j = (i + 1) % numberOfPoints;
    ...
    Util.isPointInsidePolygon = function(point, polygon) {
      var i, isPointInPolygon, j, k, numberOfVertices, pix, piy, pjx, pjy, ref, x, y;
      isPointInPolygon = false;
      x = point.x;
      y = point.y;
      numberOfVertices = polygon.length;
      j = numberOfVertices - 1;
      for (i = k = 0, ref = numberOfVertices; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
        pix = polygon[i].x;
        piy = polygon[i].y;
        pjx = polygon[j].x;
        pjy = polygon[j].y;
    ...
    Util.isGearInsidePolygon = function(gear, polygon) {
      ...
      edgePoints = (function() {
        ...
        results1 = [];
        for (i = k = 0; k < 8; i = ++k) {
          results1.push(edgePointAtAngle(0.25 * Math.PI * i));
        }
        return results1;
      })();
      return edgePoints.every((function(_this) {
        return function(p) {
    ...
    Util.pointPathDistance = function(point, path, isPathClosed) {
      var d, distance, finalIndex, i, j, k, numberOfPoints, ref, segment;
      if (isPathClosed == null) {
        isPathClosed = true;
      }
    ...
    Util.findDirection = function(polygon) {
      var doubleArea, i, j, k, numberOfPoints, ref;
      numberOfPoints = polygon.length;
      doubleArea = 0;
      for (i = k = 0, ref = numberOfPoints; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
        j = (i + 1) % numberOfPoints;
    ...
    Util.findAllSimplePathsBetweenNeighbors = function(turningObjects) {
      var i, id, j, k, m, nodes, o, paths, ref, ref1, ref2, ref3, turningObject;
      paths = [];
      nodes = (function() {
        var results1;
        results1 = [];
        for (id in turningObjects) {
          if (!hasProp.call(turningObjects, id)) continue;
          turningObject = turningObjects[id];
          results1.push(turningObject);
        }
        return results1;
      })();
      if (nodes.length < 2) {
      ...
      for (i = k = 0, ref = nodes.length - 1; 0 <= ref ? k < ref : k > ref; i = 0 <= ref ? ++k : --k) {
        for (j = m = ref1 = i + 1, ref2 = nodes.length; ref1 <= ref2 ? m < ref2 : m > ref2; j = ref1 <= ref2 ? ++m : --m) {
          if (nodes[i].connections[nodes[j].id] != null) {
            paths = paths.concat(this.findAllSimplePathsForNodes(turningObjects, nodes[j], [nodes[i]]));
          }
        }
      }
      for (i = o = 0, ref3 = paths.length; 0 <= ref3 ? o < ref3 : o > ref3; i = 0 <= ref3 ? ++o : --o) {
...
//# sourceMappingURL=gearsketch_util.js.map
